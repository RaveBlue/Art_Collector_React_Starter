...
0
  ...
  useEffect(() => {
    Promise.all([fetchAllCenturies(),fetchAllClassifications()]).then (([centuries,classification]) => {
  ...
  return <form id="search" onSubmit={async (event) => {
    ...
    <fieldset>
      ...
      <select 
        ...
        onChange={(event):void => setClassification(set)}>
